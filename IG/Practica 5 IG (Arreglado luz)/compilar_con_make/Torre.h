		...
		glPushMatrix();
			...
			if(dib_base){
				...
				glPushMatrix();
					glTranslatef(0,cont_dibujo/2,0);
					glScalef(1.5,0.5,1.5);
					base.dibujarSuavizadoPlano(grosor,ajedrez);
				glPopMatrix();
			}
			int i=0;
			for(i=1;i<=altura;i++){
				...
				glPushMatrix();
					glTranslatef(0,cont_dibujo,0);
					cubo.dibujarSuavizadoPlano(grosor,ajedrez);
				glPopMatrix();
				cont_dibujo=cont_dibujo+0.5;
			}
			if(dib_eje){
		...
		glPushMatrix();
			...
			if(dib_base){
				...
				glPushMatrix();
					glTranslatef(0,cont_dibujo/2,0);
					glScalef(1.5,0.5,1.5);
					base.dibujarSuavizadoGouraud(grosor,ajedrez);
				glPopMatrix();
			}
			int i=0;
			for(i=1;i<=altura;i++){
				...
				glPushMatrix();
					glTranslatef(0,cont_dibujo,0);
					cubo.dibujarSuavizadoGouraud(grosor,ajedrez);
				glPopMatrix();
				cont_dibujo=cont_dibujo+0.5;
			}
			if(dib_eje){
